...
public class Preset
{
    ...
    public static IEnumerable<Preset> Presets => new[]
    {
        ...
        new Preset
        {
            ...
            CharacterMoves = new[]
            {
                new CharacterMove("Eisen Sturm H (Flashkick) (SET DUMMY TO CROUCHING OR IT WONT WORK)",
                    "!8H"),
                new CharacterMove("Eisen Sturm S (Flashkick) (SET DUMMY TO CROUCHING OR IT WONT WORK)",
                    "!8S"),
        ...
        new Preset
        {
            ...
            CharacterMoves = new[]
            {
                ...
                new CharacterMove("Business Ninpo: Under the Rug (Parry) JI YRC Air Backdash",
                    "2,5,2,!8P,5*30,5PKS,5*20,4,5,4"),
