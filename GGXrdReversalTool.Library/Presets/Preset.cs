...
public class Preset
{
    ...
    public static IEnumerable<Preset> Presets => new[]
    {
        ...
        new Preset
        {
            ...
            CharacterMoves = new[]
            {
                new CharacterMove(Name: "Eisen Sturm H (Flashkick) (SET DUMMY TO CROUCHING OR IT WONT WORK)",
                    Input: "!8H"),
                new CharacterMove(Name: "Eisen Sturm S (Flashkick) (SET DUMMY TO CROUCHING OR IT WONT WORK)",
                    Input: "!8S"),
        ...
        new Preset
        {
            ...
            CharacterMoves = new[]
            {
                ...
                new CharacterMove(Name: "Business Ninpo: Under the Rug (Parry) JI YRC Air Backdash",
                    Input: "2,5,2,!8P,5*30,5PKS,5*20,4,5,4"),
